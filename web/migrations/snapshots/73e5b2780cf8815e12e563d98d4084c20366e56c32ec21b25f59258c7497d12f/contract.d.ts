...
export type StorageHash =
  StorageHashBase<'73e5b2780cf8815e12e563d98d4084c20366e56c32ec21b25f59258c7497d12f'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly AuthApikey: {
      readonly id: CodecTypes['pg/text@1']['output'];
      readonly configId: CodecTypes['pg/text@1']['output'];
      readonly name: CodecTypes['pg/text@1']['output'] | null;
      readonly start: CodecTypes['pg/text@1']['output'] | null;
      readonly referenceId: CodecTypes['pg/text@1']['output'];
      readonly prefix: CodecTypes['pg/text@1']['output'] | null;
      readonly key: CodecTypes['pg/text@1']['output'];
      readonly refillInterval: CodecTypes['pg/int4@1']['output'] | null;
      readonly refillAmount: CodecTypes['pg/int4@1']['output'] | null;
      readonly lastRefillAt: CodecTypes['pg/timestamptz-string@1']['output'] | null;
      readonly enabled: CodecTypes['pg/bool@1']['output'] | null;
      readonly rateLimitEnabled: CodecTypes['pg/bool@1']['output'] | null;
      readonly rateLimitTimeWindow: CodecTypes['pg/int4@1']['output'] | null;
      readonly rateLimitMax: CodecTypes['pg/int4@1']['output'] | null;
      readonly requestCount: CodecTypes['pg/int4@1']['output'] | null;
      readonly remaining: CodecTypes['pg/int4@1']['output'] | null;
      readonly lastRequest: CodecTypes['pg/timestamptz-string@1']['output'] | null;
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly AuthApikey: {
      readonly id: CodecTypes['pg/text@1']['input'];
      readonly configId: CodecTypes['pg/text@1']['input'];
      readonly name: CodecTypes['pg/text@1']['input'] | null;
      readonly start: CodecTypes['pg/text@1']['input'] | null;
      readonly referenceId: CodecTypes['pg/text@1']['input'];
      readonly prefix: CodecTypes['pg/text@1']['input'] | null;
      readonly key: CodecTypes['pg/text@1']['input'];
      readonly refillInterval: CodecTypes['pg/int4@1']['input'] | null;
      readonly refillAmount: CodecTypes['pg/int4@1']['input'] | null;
      readonly lastRefillAt: CodecTypes['pg/timestamptz-string@1']['input'] | null;
      readonly enabled: CodecTypes['pg/bool@1']['input'] | null;
      readonly rateLimitEnabled: CodecTypes['pg/bool@1']['input'] | null;
      readonly rateLimitTimeWindow: CodecTypes['pg/int4@1']['input'] | null;
      readonly rateLimitMax: CodecTypes['pg/int4@1']['input'] | null;
      readonly requestCount: CodecTypes['pg/int4@1']['input'] | null;
      readonly remaining: CodecTypes['pg/int4@1']['input'] | null;
      readonly lastRequest: CodecTypes['pg/timestamptz-string@1']['input'] | null;
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly auth_apikey: {
              ...
              primaryKey: { readonly columns: readonly ['id']; readonly name: 'auth_apikey_pkey' };
              uniques: readonly [];
              indexes: readonly [
                {
                  readonly name: 'auth_apikey_configId_idx';
                  readonly columns: readonly ['configId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'auth_apikey_key_idx';
                  readonly columns: readonly ['key'];
                  readonly unique: false;
                },
                {
                  readonly name: 'auth_apikey_referenceId_idx';
                  readonly columns: readonly ['referenceId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [];
            ...
            readonly kiosk: {
              ...
              uniques: readonly [{ readonly columns: readonly ['deviceId'] }];
              indexes: readonly [];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'kiosk';
                    readonly columns: readonly ['userId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
...
> & {
  ...
  readonly roots: {
    ...
    readonly kiosk: { readonly namespace: 'public' & NamespaceId; readonly model: 'Kiosk' };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
        readonly models: {
          ...
          readonly AuthApikey: {
            ...
            readonly storage: {
              readonly table: 'auth_apikey';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly configId: { readonly column: 'configId' };
                readonly name: { readonly column: 'name' };
                readonly start: { readonly column: 'start' };
                readonly referenceId: { readonly column: 'referenceId' };
                readonly prefix: { readonly column: 'prefix' };
                readonly key: { readonly column: 'key' };
                readonly refillInterval: { readonly column: 'refillInterval' };
                readonly refillAmount: { readonly column: 'refillAmount' };
                readonly lastRefillAt: { readonly column: 'lastRefillAt' };
                readonly enabled: { readonly column: 'enabled' };
                readonly rateLimitEnabled: { readonly column: 'rateLimitEnabled' };
                readonly rateLimitTimeWindow: { readonly column: 'rateLimitTimeWindow' };
                readonly rateLimitMax: { readonly column: 'rateLimitMax' };
                readonly requestCount: { readonly column: 'requestCount' };
                readonly remaining: { readonly column: 'remaining' };
