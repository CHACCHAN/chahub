...
export default async function AdminPage() {
  ...
  return <>
    ...
    <section aria-label="管理機能と利用状況" className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
      ...
      <SectionCard href="/admin/roles" title="ロール・権限" count={administrators} unit="人の管理者" description="ユーザーのロールを変更します。" />
